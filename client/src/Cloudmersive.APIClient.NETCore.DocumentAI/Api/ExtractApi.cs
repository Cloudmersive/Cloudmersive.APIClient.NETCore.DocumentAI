...
namespace Cloudmersive.APIClient.NETCore.DocumentAI.Api
{
    ...
    public interface IExtractApi : IApiAccessor
    {
        ...
        ApiResponse<SplitDocumentResponse> ExtractSplitWithHttpInfo (string recognitionMode = null, System.IO.Stream inputFile = null);
        /// <summary>
        ...
        ApiResponse<SummarizeDocumentResponse> ExtractSummaryWithHttpInfo (string recognitionMode = null, string language = null, System.IO.Stream inputFile = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<SplitDocumentResponse> ExtractSplitAsync (string recognitionMode = null, System.IO.Stream inputFile = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<SplitDocumentResponse>> ExtractSplitAsyncWithHttpInfo (string recognitionMode = null, System.IO.Stream inputFile = null);
        /// <summary>
        /// Extract Summary from a Document using AI
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<SummarizeDocumentResponse> ExtractSummaryAsync (string recognitionMode = null, string language = null, System.IO.Stream inputFile = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<SummarizeDocumentResponse>> ExtractSummaryAsyncWithHttpInfo (string recognitionMode = null, string language = null, System.IO.Stream inputFile = null);
        /// <summary>
        /// Extract Tables of Data from a Document using AI
        /// </summary>
        /// <remarks>
    ...
    public partial class ExtractApi : IExtractApi
    {
        ...
        /// <param name="inputFile">Input document containing multiple sub-documents to split (optional)</param>
        /// <returns>SplitDocumentResponse</returns>
        public SplitDocumentResponse ExtractSplit (string recognitionMode = null, System.IO.Stream inputFile = null)
        {
             ApiResponse<SplitDocumentResponse> localVarResponse = ExtractSplitWithHttpInfo(recognitionMode, inputFile);
             return localVarResponse.Data;
        }
        ...
        /// <param name="inputFile">Input document containing multiple sub-documents to split (optional)</param>
        /// <returns>ApiResponse of SplitDocumentResponse</returns>
        public ApiResponse< SplitDocumentResponse > ExtractSplitWithHttpInfo (string recognitionMode = null, System.IO.Stream inputFile = null)
        {

            var localVarPath = "./document-ai/document/extract/split";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("ExtractSplit", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<SplitDocumentResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Key, x => x.Value.ToString()),
                (SplitDocumentResponse) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(SplitDocumentResponse)));
        }
        ...
        /// <param name="inputFile">Input document containing multiple sub-documents to split (optional)</param>
        /// <returns>Task of SplitDocumentResponse</returns>
        public async System.Threading.Tasks.Task<SplitDocumentResponse> ExtractSplitAsync (string recognitionMode = null, System.IO.Stream inputFile = null)
        {
             ApiResponse<SplitDocumentResponse> localVarResponse = await ExtractSplitAsyncWithHttpInfo(recognitionMode, inputFile);
             return localVarResponse.Data;
        ...
        /// <param name="inputFile">Input document containing multiple sub-documents to split (optional)</param>
        /// <returns>Task of ApiResponse (SplitDocumentResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<SplitDocumentResponse>> ExtractSplitAsyncWithHttpInfo (string recognitionMode = null, System.IO.Stream inputFile = null)
        {
        ...
        /// <param name="inputFile">Input document, or photos of a document, to extract data from (optional)</param>
        /// <returns>SummarizeDocumentResponse</returns>
        public SummarizeDocumentResponse ExtractSummary (string recognitionMode = null, string language = null, System.IO.Stream inputFile = null)
        {
             ApiResponse<SummarizeDocumentResponse> localVarResponse = ExtractSummaryWithHttpInfo(recognitionMode, language, inputFile);
             return localVarResponse.Data;
        }
        ...
        /// <param name="inputFile">Input document, or photos of a document, to extract data from (optional)</param>
        /// <returns>ApiResponse of SummarizeDocumentResponse</returns>
        public ApiResponse< SummarizeDocumentResponse > ExtractSummaryWithHttpInfo (string recognitionMode = null, string language = null, System.IO.Stream inputFile = null)
        {
            ...
            if (recognitionMode != null) localVarHeaderParams.Add("recognitionMode", this.Configuration.ApiClient.ParameterToString(recognitionMode)); // header parameter
            if (language != null) localVarHeaderParams.Add("language", this.Configuration.ApiClient.ParameterToString(language)); // header parameter
            if (inputFile != null) localVarFileParams.Add("InputFile", this.Configuration.ApiClient.ParameterToFile("InputFile", inputFile));
        ...
        /// <param name="inputFile">Input document, or photos of a document, to extract data from (optional)</param>
        /// <returns>Task of SummarizeDocumentResponse</returns>
        public async System.Threading.Tasks.Task<SummarizeDocumentResponse> ExtractSummaryAsync (string recognitionMode = null, string language = null, System.IO.Stream inputFile = null)
        {
             ApiResponse<SummarizeDocumentResponse> localVarResponse = await ExtractSummaryAsyncWithHttpInfo(recognitionMode, language, inputFile);
             return localVarResponse.Data;
        ...
        /// <param name="inputFile">Input document, or photos of a document, to extract data from (optional)</param>
        /// <returns>Task of ApiResponse (SummarizeDocumentResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<SummarizeDocumentResponse>> ExtractSummaryAsyncWithHttpInfo (string recognitionMode = null, string language = null, System.IO.Stream inputFile = null)
        {
