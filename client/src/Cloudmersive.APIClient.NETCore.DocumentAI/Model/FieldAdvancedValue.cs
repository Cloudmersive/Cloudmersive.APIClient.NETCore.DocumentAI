...
namespace Cloudmersive.APIClient.NETCore.DocumentAI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FieldAdvancedValue :  IEquatable<FieldAdvancedValue>
    {
        /// <summary>
        ...
        public FieldAdvancedValue(string fieldName = default(string), string fieldStringValue = default(string))
        {
        ...
        {
            return this.Equals(input as FieldAdvancedValue);
        }

        /// <summary>
        /// Returns true if FieldAdvancedValue instances are equal
        /// </summary>
        /// <param name="input">Instance of FieldAdvancedValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FieldAdvancedValue input)
        {
            if (input == null)
                return false;
