...
namespace Cloudmersive.APIClient.NETCore.DocumentAI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExtractFieldsAdvancedResponse :  IEquatable<ExtractFieldsAdvancedResponse>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ExtractFieldsAdvancedResponse);
        }

        /// <summary>
        /// Returns true if ExtractFieldsAdvancedResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ExtractFieldsAdvancedResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExtractFieldsAdvancedResponse input)
        {
            if (input == null)
                return false;
