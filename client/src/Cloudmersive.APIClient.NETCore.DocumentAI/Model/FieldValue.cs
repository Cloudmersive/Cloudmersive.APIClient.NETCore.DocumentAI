...
namespace Cloudmersive.APIClient.NETCore.DocumentAI.Model
{
    ...
    public partial class FieldValue : IValidatableObject
    {
        /// <summary>
        ...
        public FieldValue(string fieldName = default, string fieldStringValue = default, List<string> additionalFieldStringValues = default)
        {
