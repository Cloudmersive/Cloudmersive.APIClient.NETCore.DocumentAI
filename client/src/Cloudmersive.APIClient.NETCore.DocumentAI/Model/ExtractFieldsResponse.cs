...
namespace Cloudmersive.APIClient.NETCore.DocumentAI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ExtractFieldsResponse")]
    public partial class ExtractFieldsResponse : IValidatableObject
    {
        /// <summary>
        ...
        public ExtractFieldsResponse(bool successful = default, List<FieldValue> results = default)
        {
