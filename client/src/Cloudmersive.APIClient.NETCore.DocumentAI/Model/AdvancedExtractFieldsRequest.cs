...
namespace Cloudmersive.APIClient.NETCore.DocumentAI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AdvancedExtractFieldsRequest")]
    public partial class AdvancedExtractFieldsRequest : IValidatableObject
    {
        /// <summary>
        ...
        public AdvancedExtractFieldsRequest(byte[] inputFile = default, List<FieldToExtract> fieldsToExtract = default, int maximumPagesProcessed = default, string preprocessing = default, string resultCrossCheck = default, double rotateImageDegrees = default)
        {
