...
namespace Cloudmersive.APIClient.NETCore.DocumentAI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DocumentClassificationResult")]
    public partial class DocumentClassificationResult : IValidatableObject
    {
        /// <summary>
        ...
        public DocumentClassificationResult(bool successful = default, string documentCategoryResult = default)
        {
