...
namespace Cloudmersive.APIClient.NETCore.DocumentAI.Test.Model
{
    ...
    public class DocumentQuestionBooleanTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" DocumentQuestionBoolean
            //Assert.IsType<DocumentQuestionBoolean>(instance);
        }
