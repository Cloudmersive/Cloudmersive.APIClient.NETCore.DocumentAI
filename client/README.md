...
*RunBatchJobApi* | [**DocumentAiDocumentBatchJobBatchJobStatusGet**](docs/RunBatchJobApi.md#documentaidocumentbatchjobbatchjobstatusget) | **GET** /document-ai/document/batch-job/batch-job/status | Get the status and result of an Extract Document Batch Job
*RunBatchJobApi* | [**DocumentAiDocumentBatchJobExtractAllPost**](docs/RunBatchJobApi.md#documentaidocumentbatchjobextractallpost) | **POST** /document-ai/document/batch-job/extract/all | Extract All Fields and Tables of Data from a Document using AI as a Batch Job
*RunBatchJobApi* | [**DocumentAiDocumentBatchJobExtractClassifyPost**](docs/RunBatchJobApi.md#documentaidocumentbatchjobextractclassifypost) | **POST** /document-ai/document/batch-job/extract/classify | Extract Classification or Category from a Document using AI as a Batch Job
*RunBatchJobApi* | [**DocumentAiDocumentBatchJobExtractFieldsAdvancedPost**](docs/RunBatchJobApi.md#documentaidocumentbatchjobextractfieldsadvancedpost) | **POST** /document-ai/document/batch-job/extract/fields/advanced | Extract Field Values from a Document using Advanced AI as a Batch Job
*RunBatchJobApi* | [**DocumentAiDocumentBatchJobExtractTextPost**](docs/RunBatchJobApi.md#documentaidocumentbatchjobextracttextpost) | **POST** /document-ai/document/batch-job/extract/text | Extract Text from a Document using AI as a Batch Job
