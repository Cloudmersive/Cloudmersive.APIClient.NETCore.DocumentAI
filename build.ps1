...
& java -jar swagger-codegen-cli-2.4.12.jar generate -i https://api.cloudmersive.com/document-ai/docs/v1/swagger -l csharp -o client -c packageconfig.json
...
(Get-Content ./client/src/Cloudmersive.APIClient.NETCore.DocumentAI/Cloudmersive.APIClient.NETCore.DocumentAI.csproj).replace('<Description>A library generated from a Swagger doc</Description>', "<Description>Document AI APIs let you use Machine Learning to recognize and process images, and also perform useful image modification operations.</Description>") | Set-Content ./client/src/Cloudmersive.APIClient.NETCore.DocumentAI/Cloudmersive.APIClient.NETCore.DocumentAI.csproj
